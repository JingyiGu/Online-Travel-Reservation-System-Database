...
<body>
	<%
		...
		String cstAccount = session.getAttribute("customer_account").toString();
		String reservationNo = request.getParameter("reservationNo");
		System.out.println("customer_account: " + cstAccount);
		...
		try {
			...
			String strQuery = "SELECT R.reserve_num, F.airline_id,F.flight_num,F.from_air,F.to_air,F.depart_time,T.depart_date,F.arrival_time,T.arrival_date "
					...
					+ " WHERE R.reserve_num=? AND R.acct_num=4872839 AND R.reserve_num=L.reserve_num AND L.airline_id=F.airline_id"
...
// 			System.out.println(" debuggable statement= " + stm.toString());
			...
			String queryType = "Travel itinerary for the selected reservation: '" + reservationNo + "'";
